{{Form::open(array('action'=>array('CitasController@destroy',code($cita->id)),'method'=>'delete', 'onsubmit'=>'deleteboton.disabled = true; return true;'))}}
    ...
    <div class="modal-body text-center py-4">
        ...
        <div class="text-muted">
            ¿Está seguro de eliminar la cita <b>{{$cita->cod}}</b>?
        </div>
    </div>

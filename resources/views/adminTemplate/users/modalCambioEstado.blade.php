...
<div class="modal-status @if($users->active == 1) bg-yellow @else bg-primary @endif"></div>
    ...
    <div class="modal-footer">
        <div class="w-100">
            <div class="row">
                ...
                <div class="col">
                    <button type="submit" class="btn @if($users->active == 1) btn-yellow @else btn-primary @endif w-100" name="btnCambEstado">Confirmar</button>
                </div>
            </div>
        </div>
    </div>

<div class="modal modal-danger fade modal-slide-in-right" aria-hidden="true" role="dialog"  id="modalDelete-{{$ejemplo->id}}" data-backdrop="static">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">


            {{Form::open(array('action'=>array('EjemploController@destroy',code($ejemplo->id)),'method'=>'delete', 'onsubmit'=>'deleteboton.disabled = true; return true;'))}}
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">
                        ¿Está seguro de eliminar el registro {{$ejemplo->cod}}?
                    </div>
                </div>
